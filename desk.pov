...
//                     translate x*(frontElementWidth-(thkSide+0.005+0.5*thk+0.005)-1.1*thk)
                }
                #for (id, 0, 9, 1)
                    object{ 
                        Register(mod(id,5))
...
object{DeskInst1(0.0,max(0.5,0.5+0.5*0.25*(clock_-9)),0.5,0,0.0,0.0,0.,0.)}
